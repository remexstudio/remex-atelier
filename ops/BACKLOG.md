...
- [ ] C0 — **ACTIVE** — `docs/CANON.md` company spirit + construction doctrine. Docs only. Awaiting Leader REVIEW. Do not start C1 in the C0 PR.
- [ ] C1 — product footer
- [ ] C2 — Approach legal
...
V7 appearance closed and superseded by owner continuous UI FAIL. UI-0…UI-5 appearance campaign is **CLOSED**. No Seattle/Global. No founder. No /demo as product. Do not rewrite thesis/offers/routes from that campaign.

- [x] V6-0…V6-6
- [x] V7-0…V7-3 — **CLOSED / SUPERSEDED** by owner live first-screen FAIL
...
- [x] UI-4 hold 375 and 1280/1440 layout — **PASS** (`d375f98`)
